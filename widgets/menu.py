...
class Menu(QFrame):
    def __init__(self, stacked_widget_trigger=None, parent=None):
        ...
        self.stickers_button.setIcon(svg_to_icon(os.path.join("utils", "ui", "sticker.svg"), QSize(icon_px, icon_px), button_color))
        ...
        self.notes_button.setIcon(svg_to_icon(os.path.join("utils", "ui", "notebook.svg"), QSize(icon_px, icon_px), button_color))
        ...
        self.bookmarks_button.setIcon(svg_to_icon(os.path.join("utils", "ui", "bookmark.svg"), QSize(icon_px, icon_px), button_color))
